...
% Plot solution
plot_function_new(output1,output2, [output1.x(end,1) output1.x(end,2)], [output2.x(end,1) output2.x(end,2)]);

%plot_function_(output1,[output1.x(end,1) output1.x(end,2)])
